...
import { Book, BookOpen, Library, Plus } from "lucide-react";
  ...
  return (
    <div className="flex items-center justify-center min-h-[70vh]">
      <EmptyState
        ...
        description="Start building your collection by adding books, articles, and resources."
        icons={[Book, BookOpen, Library]}
        action={{
